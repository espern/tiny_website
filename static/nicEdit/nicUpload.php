...
define('NICUPLOAD_PATH', '../static/images/pages_content/'); // Set the path (relative or absolute) to
                                      // the directory to save image files
                                      
define('NICUPLOAD_URI', '../static/images/pages_content/');   // Set the URL (relative or absolute) to
